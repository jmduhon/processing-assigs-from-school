...
class Particle {
  ...
  void update() {
    velocity.x = 0.1*cos(TWO_PI*noise(0.01*position.x,0.01*position.y,0.01*position.z));
    velocity.y = 0.1*sin(TWO_PI*noise(0.01*position.x,0.01*position.y,0.01*position.z));
